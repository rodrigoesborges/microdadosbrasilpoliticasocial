...
pt_n <- c("Mínimo","Mediana","Média","Máximo",rep(c("Mínimo","Mediana","Média","Máximo","Desconhecidos"),7))
...
qable(resultados_saude_sumario, rgroup = setNames(c(4,rep(5,7)),names(sumarios_auto)), cnames = 2012:2017,rnames = pt_n)
```
...
qable(res_sa_es, rgroup = setNames(c(4,rep(5,7)),names(sumarios_auto)), cnames = 2012:2017,rnames = pt_n)
```
